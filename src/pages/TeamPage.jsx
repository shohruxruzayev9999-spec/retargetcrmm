          ...
          {grouped.map((group) => (
            <div key={group.dept}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}>
                <div style={{ width: 10, height: 10, borderRadius: "50%", background: { "SMM bo'limi": T.colors.indigo, "Target bo'limi": T.colors.orange, "Media bo'limi": T.colors.accent, "Grafik dizayn bo'limi": T.colors.purple, "Sales bo'limi": T.colors.green, "Project Management": T.colors.purple, Boshqaruv: T.colors.text }[group.dept] || T.colors.accent }} />
